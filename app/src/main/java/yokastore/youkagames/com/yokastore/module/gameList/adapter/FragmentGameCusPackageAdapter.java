...
public class FragmentGameCusPackageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private ItemClickCallBack clickCallBack;
    private Activity mContext;
    private GameDetailModel.GameDetailData gameDetailData;
    private ArrayList<GamePackageModel.DataBean> gameCusPackageData;

    public void setClickCallBack(ItemClickCallBack clickCallBack) {
        this.clickCallBack = clickCallBack;
    }

    public FragmentGameCusPackageAdapter(Activity context,GameDetailModel.GameDetailData data){
        mContext = context;
        gameDetailData = data;
    }

    public void updateGameCusPackageData(ArrayList<GamePackageModel.DataBean> dataBeans){
        gameCusPackageData  = dataBeans;
    }
    ...
    private void setGameDetailData(int position, ViewTypeTwoHolderScore holder){
        if (gameCusPackageData != null && gameCusPackageData.size() > 0){
            GamePackageModel.DataBean dataBean = gameCusPackageData.get(position);
