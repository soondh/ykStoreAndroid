...
import yokastore.youkagames.com.yokastore.module.gameList.adapter.FragmentGameRelPackageAdapter;
...
public class GameRelPackFragment extends BaseFragment implements IBaseView{
    ...
    private FragmentGameRelPackageAdapter mAdapter;
    ...
    private void initRecycleView() {
        ...
        mRecyclerView.setLoadingListener(new GameRelPackFragment.RecycleLoadingListener());
        mAdapter = new FragmentGameRelPackageAdapter(getActivity(),mGameDetailData);

        mAdapter.setClickCallBack(new FragmentGameRelPackageAdapter.ItemClickCallBack() {
            @Override
    ...
    public void initDataFragment() {
        ...
        mPresenter.getGamePackageDatas(mGameDetailData.projectId,"Android","Stable");
        initRecycleView();
    }
        ...
        if (data.code == 0) {
            if (data instanceof GamePackageModel) {
                ...
                if (model.data != null && model.data.size() > 0) {
                    ...
                    mAdapter.updateGameRelPackageData(mGamePackageDatas);
                    if(mRecyclerView != null) {
